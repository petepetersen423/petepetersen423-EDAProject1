...
#Plot 2 Top Right
plot(dfpowerDateNeeded$Date + dfpowerDateNeeded$Time,dfpowerDateNeeded$Voltage, 
     col = "black", 
     ylab = "Voltage",
     xlab = "Days",
     type = "l")
...
#Plot 4 Bottom Left
plot(dfpowerDateNeeded$Date + dfpowerDateNeeded$Time,dfpowerDateNeeded$Global_reactive_power, 
     col = "black", 
